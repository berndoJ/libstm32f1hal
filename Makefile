...
STM32F100xB: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F100xE: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F101x6: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F101xB: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F101xE: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F101xG: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F102x6: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F102xB: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F103x6: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F103xB: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F103xE: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F103xG: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F105xC: buildinfo $(BINDIR)/$(PROJECTNAME).a
STM32F107xC: buildinfo $(BINDIR)/$(PROJECTNAME).a
